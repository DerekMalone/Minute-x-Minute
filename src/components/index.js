...
export { default as CoachesPractDetails } from './coachesComponents/CoachesPractDetails';
export { default as CoachesPracticeForm } from './coachesComponents/CoachesPractForm';
// export { default as CoachesPracticeComp } from './coachesComponents/CoachesPracticeComp';git
